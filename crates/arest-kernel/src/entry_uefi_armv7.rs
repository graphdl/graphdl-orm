...
//   * Static-BSS `LockedHeap` heap (post-EBS-safe, parallels aarch64
...
// byte-for-byte: same crate, same size (16 MiB), same `static` +
// UnsafeCell wrapping, same init-at-top-of-efi_main discipline.
//
