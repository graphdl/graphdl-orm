...
//   graphdl-rules --ir <ir.json> --synthesize <noun_name> [--depth <n>]
//   graphdl-rules --ir <ir.json> --forward-chain --population <population.json>
    ...
    while i < args.len() {
        match args[i].as_str() {
            ...
            "--help" | "-h" => {
                ...
                eprintln!("  graphdl-rules --ir <ir.json> --synthesize <noun> [--depth <n>]");
                eprintln!("  graphdl-rules --ir <ir.json> --forward-chain --population <pop.json>");
