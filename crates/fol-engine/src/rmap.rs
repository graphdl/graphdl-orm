...
//
// Pure function: ConstraintIR → table definitions.
...
fn column_name_for_target(ir: &ConstraintIR, noun_name: &str) -> String {
...
pub fn rmap(ir: &ConstraintIR) -> Vec<TableDef> {
...
pub fn rmap_from_loaded_ir(ir: &ConstraintIR) -> Vec<TableDef> {
    rmap(ir)
}
