...
Status 'Proposed' is initial in State Machine Definition 'Feature Request'.

Transition 'approve' is defined in State Machine Definition 'Feature Request'.
...
Transition 'startWork' is defined in State Machine Definition 'Feature Request'.
...
Transition 'deploy' is defined in State Machine Definition 'Feature Request'.
