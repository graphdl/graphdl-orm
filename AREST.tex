...
A \emph{Representational State Transfer} system (Fielding, 2000) communicates state between distributed components by transferring representations via a uniform interface. \emph{Hypermedia as the engine of application state} (HATEOAS): each response includes links encoding valid state transitions.
\end{definition}
