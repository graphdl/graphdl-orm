...
An \emph{Applicative REpresentational State Transfer} system is the composition $\text{AST} \circ \text{REST}$: the representational state being transferred is the applicative state being transformed, rendered as hypermedia with transition links. Programs compute state; the API exposes those computations as navigable transitions.
\end{definition}
