...
A \emph{Representational State Transfer} system~\cite{fielding00} communicates state between distributed components by transferring representations via a uniform interface. Hypermedia links in the representation encode valid state transitions (HATEOAS).
\end{definition}
...
\bibitem{halpin20}
T. Halpin.
\newblock Objectification and Atomicity.
\newblock Unpublished note, updated 2020.
...
\newblock In \emph{To H.B. Curry: Essays on Combinatory Logic, Lambda Calculus and Formalism}, pages 479--491. Academic Press, 1980.
