...
placeholder; forward hyphen binding (adj-Type → role Type); the atomic
...
def test_forward_hyphen_binding_binds_the_type_tail():
    assert _parse("Layer has valence-Coord", ("Layer", "Coord")) == \
        ("{0} has {1}", ("Layer", "Coord"))
